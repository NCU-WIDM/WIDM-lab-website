...
interface TableProps {
  ...
  onPinTop?: (id: number, checked: boolean) => void;
}
                ...
                {headers.map((header) =>
                  !header.isEnable || header.isEnable === 'true' ? (
                    <td
                      ...
                      style={
                        header.style ? header.style : { minWidth: '200px' }
                      }
                    >
                      ...
                      {header.id === 'imageActions' &&
                        (onUploadFile || onDeleteFiles) && ( // 上傳單張圖片
                              ...
                              {row.image_existed && (
                                <img
                                  ...
                                  src={
                                    row.imageUrl
                                      ? row.imageUrl
                                      : `${apiUrl}/${page}/${row['id']}/${header.Name}`
                                  }
                      ...
                      {header.id === 'imagesActions' &&
                        (onUploadFile || onDeleteFiles || onEditImage) && ( // 上傳多張圖片
                          <div className="flex items-center space-x-3.5">
                            {onEdit && (
                              <button
                                className="hover:text-primary"
                      ...
                      {header.effect === 'importance' && onPinTop && (
                        <Switch
