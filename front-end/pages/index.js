        ...
        <div className="pt-6 pb-8 md:space-y-5">
          <div className="flex flex-col xl:flex-row gap-4">
            <div className="flex-1">
              <h1 className="text-2xl font-bold leading-8 tracking-tight text-gray-900 dark:text-gray-100 sm:text-3xl sm:leading-9 md:text-4xl md:leading-10">{siteMetadata.labName}</h1>
              <h2 className="text-lg font-semibold mt-3 mb-1 text-gray-700 dark:text-gray-500">位置</h2>
              <p className="mb-2 text-base text-gray-600 dark:text-gray-500">{siteMetadata.address}</p>
